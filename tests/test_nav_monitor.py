...
def test_scheduler_nav_push_sends_due_periods_after_daily(monkeypatch):
    ...
    monkeypatch.setattr(
        src.scheduler, "_require_portfolio_repository", lambda: object()
    )
    monkeypatch.setattr(
        src.portfolio_reports, "push_portfolio_report", fake_push
    )
    monkeypatch.setattr(
        src.scheduler,
...
def test_scheduler_nav_evening_push_calls_evening_report(monkeypatch):
    ...
    monkeypatch.setattr(
        src.portfolio_reports, "push_portfolio_report", fake_evening
    )
