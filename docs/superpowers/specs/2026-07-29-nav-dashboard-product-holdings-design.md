...
- `shares="10000"`，`nav="abc"` → `"10000.00 份"`（仅份额）
...
- `shares=None`，`nav="1.0"` → `""`（None 视为空）
- `shares="10000"`，`nav=None` → `"10000.00 份"`（仅份额）
- `shares="nan"`，`nav="1.0"` → `""`（NaN 守卫）
- `shares="10000"`，`nav="nan"` → `"10000.00 份"`（NaN 守卫）
- `shares="inf"`，`nav="1.0"` → `""`（Inf 守卫）
- `shares="10000"`，`nav="-inf"` → `"10000.00 份"`（Inf 守卫）
- `shares="10000"`，`nav="0"` → `"10000.00 份 · 市值 0.00 元"`（零净值边界）
